...
abstract class ArticlesServiceClientI {
  Future<articles_pb.GetArticlesResponse> getArticles(articles_pb.GetArticlesRequest input);
  Future<articles_pb.GetArticleResponse> getArticle(articles_pb.GetArticleRequest input);
  Future<articles_pb.ParseArticleResponse> parseArticle(articles_pb.ParseArticleRequest input);
