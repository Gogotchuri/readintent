...
def load_config() -> Config:
	return Config(
		...
		browser_max_tabs=int(os.environ.get("BROWSER_MAX_TABS", str(Config.browser_max_tabs))),
		browser_restart_after=int(os.environ.get("BROWSER_RESTART_AFTER", str(Config.browser_restart_after))),
		browser_timeout=float(os.environ.get("BROWSER_TIMEOUT", str(Config.browser_timeout))),
	)
