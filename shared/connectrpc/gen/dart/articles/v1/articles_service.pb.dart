...
class ArticlePreview extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ArticlePreview', package: const $pb.PackageName(_omitMessageNames ? '' : 'articles.v1'), createEmptyInstance: create)
    ...
    ..e<ArticleListState>(12, _omitFieldNames ? '' : 'listState', $pb.PbFieldType.OE, defaultOrMaker: ArticleListState.ARTICLE_LIST_STATE_UNSPECIFIED, valueOf: ArticleListState.valueOf, enumValues: ArticleListState.values)
  ...
  @$pb.TagNumber(12)
  set listState(ArticleListState v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set isFavorite($core.bool v) { $_setBool(12, v); }
  @$pb.TagNumber(13)
...
class Article extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Article', package: const $pb.PackageName(_omitMessageNames ? '' : 'articles.v1'), createEmptyInstance: create)
    ...
    ..e<ArticleListState>(16, _omitFieldNames ? '' : 'listState', $pb.PbFieldType.OE, defaultOrMaker: ArticleListState.ARTICLE_LIST_STATE_UNSPECIFIED, valueOf: ArticleListState.valueOf, enumValues: ArticleListState.values)
  ...
  @$pb.TagNumber(16)
  set listState(ArticleListState v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set isFavorite($core.bool v) { $_setBool(16, v); }
  @$pb.TagNumber(17)
...
class GetArticlesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetArticlesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'articles.v1'), createEmptyInstance: create)
    ...
    ..e<ArticleView>(6, _omitFieldNames ? '' : 'view', $pb.PbFieldType.OE, defaultOrMaker: ArticleView.ARTICLE_VIEW_UNSPECIFIED, valueOf: ArticleView.valueOf, enumValues: ArticleView.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set view(ArticleView v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class SetArticleStateRequest extends $pb.GeneratedMessage {
  ...
  factory SetArticleStateRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetArticleStateRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetArticleStateRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'articles.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..e<ArticleListState>(2, _omitFieldNames ? '' : 'listState', $pb.PbFieldType.OE, defaultOrMaker: ArticleListState.ARTICLE_LIST_STATE_UNSPECIFIED, valueOf: ArticleListState.valueOf, enumValues: ArticleListState.values)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SetArticleStateRequest clone() => SetArticleStateRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetArticleStateRequest copyWith(void Function(SetArticleStateRequest) updates) => super.copyWith((message) => updates(message as SetArticleStateRequest)) as SetArticleStateRequest;
  ...
  static $pb.PbList<SetArticleStateRequest> createRepeated() => $pb.PbList<SetArticleStateRequest>();
  @$core.pragma('dart2js:noInline')
  static SetArticleStateRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetArticleStateRequest>(create);
  ...
  @$pb.TagNumber(2)
  set listState(ArticleListState v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SetArticleStateResponse extends $pb.GeneratedMessage {
  ...
  factory SetArticleStateResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetArticleStateResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetArticleStateResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'articles.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SetArticleStateResponse clone() => SetArticleStateResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetArticleStateResponse copyWith(void Function(SetArticleStateResponse) updates) => super.copyWith((message) => updates(message as SetArticleStateResponse)) as SetArticleStateResponse;
  ...
  static $pb.PbList<SetArticleStateResponse> createRepeated() => $pb.PbList<SetArticleStateResponse>();
  @$core.pragma('dart2js:noInline')
  static SetArticleStateResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetArticleStateResponse>(create);
...
class ArticlesServiceApi {
  ...
  ;
  $async.Future<SetArticleStateResponse> setArticleState($pb.ClientContext? ctx, SetArticleStateRequest request) =>
    _client.invoke<SetArticleStateResponse>(ctx, 'ArticlesService', 'SetArticleState', request, SetArticleStateResponse())
  ;
